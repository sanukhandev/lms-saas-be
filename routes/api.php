...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'tenant.access'])->group(function () {
        ...
        Route::prefix('courses')->group(function () {
            ...
            Route::get('/{course}/analytics', [App\Http\Controllers\Api\CourseController::class, 'getAnalytics']);
        ...
        Route::prefix('course-builder')->group(function () {
            ...
            Route::put('/modules/{moduleId}', [App\Http\Controllers\Api\CourseBuilderController::class, 'updateModule']);
            Route::delete('/modules/{moduleId}', [App\Http\Controllers\Api\CourseBuilderController::class, 'deleteModule']);
            Route::post('/{courseId}/modules/{moduleId}/chapters', [App\Http\Controllers\Api\CourseBuilderController::class, 'createChapter']);
            Route::put('/chapters/{chapterId}', [App\Http\Controllers\Api\CourseBuilderController::class, 'updateChapter']);
            Route::delete('/chapters/{chapterId}', [App\Http\Controllers\Api\CourseBuilderController::class, 'deleteChapter']);
            ...
            Route::get('/{courseId}/local-pricing', [App\Http\Controllers\Api\CourseBuilderController::class, 'getLocalPricing']);
            Route::get('/bulk-pricing', [App\Http\Controllers\Api\CourseBuilderController::class, 'getBulkPricing']);
            Route::post('/{courseId}/validate-pricing', [App\Http\Controllers\Api\CourseBuilderController::class, 'validatePricing']);
        });
